...
{	
	...
	auto DistanceToWhiteText = tr("Distance to White: %1").arg(ColorStats.DistanceToWhite);
	...
	m_DistanceToWhiteLabel = new QLabel{ DistanceToWhiteText, this };
	...
	VertLayout->addWidget(m_DistanceToWhiteLabel);
}